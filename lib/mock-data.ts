    ...
    durAlerts: [
      {
        ...
        severity: 'medium',
        description: 'Interacting agents: Metformin HCl 500mg (active) + iodinated contrast media (if scheduled).\nSeverity: MODERATE — contrast-induced nephropathy risk.\nMechanism: Iodinated contrast can transiently impair renal function; metformin accumulation in the setting of acute kidney injury increases lactic acidosis risk (rare but serious).\nRecommendation: Hold metformin 48 hours prior to and following iodinated contrast procedures. Recheck renal function (eGFR) before resuming. No action required if no contrast procedure is planned.\nSource: FDB MedKnowledge',
        acknowledged: false,
      },
    ],
    copay: 5.00,
    ...
    durAlerts: [
      {
        ...
        type: 'drug_interaction',
        severity: 'high',
        description: "Interacting agents: Sertraline HCl 100mg (active, filled 2024-01-08) + new Tramadol HCl 50mg Rx.\nSeverity: HIGH — Serotonin Syndrome risk.\nMechanism: Tramadol inhibits serotonin reuptake and sertraline is a potent SSRI; combined serotonergic excess can precipitate serotonin syndrome (hyperthermia, rigidity, clonus, altered mental status). Risk is highest at tramadol initiation or dose increase.\nRecommendation: Consider alternative analgesic (acetaminophen, NSAIDs if not contraindicated, or low-dose opioid without serotonergic activity). If tramadol is clinically necessary, initiate at lowest dose with enhanced monitoring. Pharmacist override with documented clinical justification required.\nSource: FDB MedKnowledge",
        acknowledged: false,
      },
      {
        id: 'dur003',
        type: 'duplicate',
        severity: 'medium',
        description: "Therapeutic duplication: Sertraline HCl 100mg (new Rx) + Escitalopram 10mg (active, last filled 2024-01-05).\nSeverity: MODERATE — Duplicate SSRI therapy.\nMechanism: Both agents are selective serotonin reuptake inhibitors (SSRIs); concurrent use provides no additional antidepressant benefit and increases serotonin syndrome risk and adverse effect burden.\nRecommendation: Confirm with prescriber whether this Rx is intended to replace escitalopram or was ordered in error. If switching, ensure appropriate taper of escitalopram.\nSource: FDB MedKnowledge",
        acknowledged: false,
      },
    ],
    copay: 8.00,
